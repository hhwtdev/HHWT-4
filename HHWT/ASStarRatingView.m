...
- (void)baseInit {
    _notSelectedStar = [[UIImage imageNamed:@"star.png"] retain];
    _selectedStar = [[UIImage imageNamed:@"fullstar.png"] retain];
    _halfSelectedStar = [[UIImage imageNamed:@"halfstar.png"] retain];
