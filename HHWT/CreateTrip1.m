...
@interface CreateTrip1 ()<UICollectionViewDelegate, UICollectionViewDataSource>
{
...
@implementation CreateTrip1

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"Create Trip";
    
    [_createTripCollectionView registerNib:[UINib nibWithNibName:@"ExploreNewCell" bundle:nil] forCellWithReuseIdentifier:@"exploreCell"];
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    if([[jsonDict objectForKey:@"Status"] integerValue] == 1) {
        ...
        [_createTripCollectionView reloadData];
    }else {
